...
int main() {
	...
	//Области применения многофайлоых проектов:
	//1. Разбивка кода на разные файлы для удобства работы с ним;
	//2. Создание собственых библиотек для использования их в разных проектах;
	//3. Ускорение сборки проекта.*/
	
	//Бибилеотека со стурктурой и функциями для работы с ней 
	/*person p1{
		"Tom Hencs",
		26,
		"programer",
